        ...
        <section>
            <div>
                <FormCard
                    ...
                    headingStyle="font-semibold xl:text-4xl lg:text-2xl text-xl lg:text-auth text-white"
                    ...
                    authMsgStyle="text-center font-semibold xl:text-3xl lg:text-xl text-lg text-auth capitalize"
                />
            </div>
        </section>
    )
