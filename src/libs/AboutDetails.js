...
const WCVGText = [
    {
      reHeading: "A Unique and Diverse Collection",
      inContent:
        "Viks Gallery, offers an extensive selection of artwork across various styles, mediums and genres. Our diverse gallery ensures that you’ll find something that truly resonates with your personal taste and vision.",
    },
    {
      reHeading: "Expert Guidance from Art Professionals",
      inContent:
        "Our dedicated art advisors bring years of experience and passion to each consultation, providing tailored advice to match your needs. From helping you under stand different art styles to offering insight into the artists background.",
    },
    {
      reHeading: "Commitment to Customer Satisfaction",
      inContent:
        "At Viks Gallery, we go above and beyond to make your art buying process smooth and enjoyable, offering framing shipping and installation services. With a strong focus on customer satisfaction we ensure every customer is happy and satisfied.",
    },
  ];
...
export {AboutMsg, ArtiseHandels, WCVGText, Teams}