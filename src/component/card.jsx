...
export const Card = ({ items, title, subTitle, renderItem, style, inStyle, subStyle, swipe, sliperElement, normalDiv }) => {
        ...
        <section className="p-4 lg:p-9">
            <div className="flex items-center flex-col gap-4 lg:gap-9 w-full">
                <div className="text-center">
                    <h3 className="text-xl md:text-2xl lg:text-3xl capitalize font-bold">{title}</h3>
